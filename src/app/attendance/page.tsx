          ...
          {activeTab === 'create' ? (
            ...
            <div className="space-y-6">
              ...
              <SalaryDetailModal
                ...
                viewingSalaryWorker={viewingSalaryWorker}
                workerAttendanceView={workerAttendanceView}
                isLoadingWorkerAttendance={isLoadingWorkerAttendance}
                overviewMonth={overviewMonth}
                calculateTotalWorkQuantity={calculateTotalWorkQuantity}
                calculateTotalOvertime={calculateTotalOvertime}
                formatCurrency={formatCurrency}
              ...
              <DeleteConfirmModal
                ...
                workerName={workers.find((w) => w.id === showDeleteConfirm)?.name || ''}
                onConfirm={() => showDeleteConfirm !== null && handleDeleteWorker(showDeleteConfirm)}
              />
            </div>
          ) : activeTab === 'overview' ? (
            <div className="space-y-6 p-4 sm:p-6">
