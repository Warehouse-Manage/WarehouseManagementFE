...
interface PaymentModalProps {
  ...
  onLoadMonthlyTotal: (deliverId: number, month: string) => void;
  onSubmit: () => void;
}
...
export default function PaymentModal({
  ...
  if (!selectedDeliver) return null;

  const maxAmount = (selectedDeliver.amountMoneyTotal || 0) - (selectedDeliver.amountMoneyPaid || 0);
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div className="text-sm font-bold text-gray-900">{(selectedDeliver.amountMoneyTotal || 0).toLocaleString('en-US')}đ</div>
          </div>
          <div className="bg-green-50 p-3 rounded-xl border border-green-100 shadow-sm">
            ...
            <div className="text-sm font-bold text-green-600">{(selectedDeliver.amountMoneyPaid || 0).toLocaleString('en-US')}đ</div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (e.target.value) {
                  onLoadMonthlyTotal(selectedDeliver.id, e.target.value);
                }
              }}
