...
import MaterialSelectorModal from "./modal/MaterialSelectorModal";
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-100 flex justify-center sm:justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={submitting}
              className="inline-flex items-center justify-center rounded-lg bg-orange-600 px-8 py-2.5 text-sm font-black text-white shadow-lg hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-inter cursor-pointer"
            >
              {submitting ? (
                <>
      ...
      <CreateMaterialModal
        ...
        createMaterialFormFields={createMaterialFormFields}
        newMaterial={newMaterial}
        createError={createError}
        creatingMaterial={creatingMaterial}
        onMaterialChange={(name, val) =>
