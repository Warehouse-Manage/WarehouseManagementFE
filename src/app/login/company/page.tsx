...
export default function LoginCompanyPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            const data = await companyApi.lookup(name);
            ...
            toast.success(`Đã chọn: ${data.name}`);
            router.push('/login');
        } catch {
            toast.error('Không tìm thấy công ty. Kiểm tra tên hoặc tạo công ty mới.');
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 sm:p-8">
                    <div className="text-center mb-6">
                        ...
                        <h1 className="text-xl sm:text-2xl font-bold text-gray-800 tracking-tight">Chọn công ty</h1>
                        <p className="text-gray-600 text-sm mt-1">Nhập tên công ty để đăng nhập tài khoản người dùng</p>
                    </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="Ví dụ: gachchanhhoa"
                                />
                            </div>
                        </div>
                    ...
                    <div className="mt-6 text-center border-t border-gray-100 pt-6">
                        <p className="text-sm text-gray-600">
                            Chưa có công ty?{' '}
                            <Link href="/login/create-company" className="font-semibold text-orange-600 hover:text-orange-500 hover:underline">
                                Tạo công ty mới
                            </Link>
                        </p>
                    </div>
