...
import { Package, Search, Plus, Activity, AlertTriangle } from 'lucide-react';
import Link from 'next/link';
import Image from 'next/image';
import MaterialRequestModal from './modal/MaterialRequestModal';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 bg-white p-8 rounded-3xl border border-gray-100 shadow-xl shadow-gray-50/50">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          ...
          <button
            onClick={() => router.push('/supplies/requests')}
